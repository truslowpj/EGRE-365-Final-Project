...
HD_PWD='C:/Users/peter/Documents/GitHub/EGRE-365-Final-Project/EGRE-365-Final-Project/EGRE-365-Final-Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_toplevel.tcl
